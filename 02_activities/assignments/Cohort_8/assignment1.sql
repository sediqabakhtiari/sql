...
ORDER by vendor.vendor_name, vb.market_date;
...
sum (customer_purchases.quantity * customer_purchases.cost_to_customer_per_qty) as total_purchased
FROM customer
...
ORDER by customer.customer_first_name, customer.customer_last_name;
...
INSERT INTO temp.new_vendor_copy2
